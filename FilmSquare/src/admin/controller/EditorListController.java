...
@WebServlet("/admin/eboard/list.do")
public class EditorListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//전체 글 갯수 얻기 위한 서비스객체 필요
	 	IAdminEboardService adminEboardService = AdminEboardServiceImpl.getInstance();
		int totalCount = adminEboardService.ecountList(); //전체 글갯수
...
//			}
		...
		List<EditorBoardVO> editorList = adminEboardService.editorList(map);
		...
		req.getRequestDispatcher("/views/admin/eboard/editorList.jsp").forward(req, resp);
	}
