...
@WebServlet("/admin/mboard/List/update.do")
public class MemberUpdateController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int cnt = mboardService.listUpdate(mv);
		System.out.println("cnt"+mv);
		...
		// 목록 화면으로 리다이렉팅 처리
//		resp.sendRedirect(req.getContextPath() + "/admin/mboard/List.do");
